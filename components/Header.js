...
function Header({ placeholder }) {
  ...
  // This will pass the query params to the redirected page
  const search = () => {
    router.push({
      pathname: "/search",
      query: {
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <SearchIcon
          className="h-8 bg-red-400 text-white rounded-full 
        p-2 cursor-pointer hidden md:inline-flex md:mx-2"
        />
      </div>

      {/* Right */}
      <div className="flex items-center space-x-4 justify-end text-gray-500">
        <p className="hidden md:inline cursor-pin">Become a host</p>
